...
func (r *ResolverCache) getIPFromCache(fqdn string, ipv int) ([]net.IP, bool) {
...
func NewCachedResolver() *ResolverCache {
...
func (r *ResolverCache) resolveWithoutCache(fqdn string, ipv int) (*cacheEntry, error) {
...
func (r *ResolverCache) LookupHost(ctx context.Context, host string, ipv int) (addrs []string, err error) {
...
func (r *ResolverCache) resolveHost(ctx context.Context, host string, ipv int) ([]net.IP, error) {
...
func (r *ResolverCache) gcOldRecords() {
