...
const ( // equality
	shouldHaveBeenEqual             = "Actual value '%v' should be equal to the expected value '%v' (but it wasn't)!"
	shouldNotHaveBeenEqual          = "Actual value '%v'\nto NOT equal '%v'\n(but it did)!"
...
const ( // quantity comparisons
	shouldHaveBeenGreater            = "Actual value '%v' should be greater than the expected value '%v' (but it wasn't)!"
	shouldHaveBeenGreaterOrEqual     = "Actual value '%v' should be greater than or equal to the expected value '%v' (but it wasn't)!"
	shouldHaveBeenLess               = "Actual value '%v' should be less than the expected value '%v' (but it wasn't)!"
	shouldHaveBeenLessOrEqual        = "Actual value '%v' should be less than or equal to the expected value'%v' (but it wasn't)!"
	shouldHaveBeenBetween            = "Actual value '%v' should be between the expected value '%v' and '%v' (but it wasn't)!"
	shouldNotHaveBeenBetween         = "Actual value '%v' should be NOT to be between the expected value '%v' and '%v' (but it was)!"
	shouldHaveDifferentUpperAndLower = "The lower and upper bounds must be different values (they were both '%v')."
	shouldHaveBeenBetweenOrEqual     = "Actual value '%v' to be between '%v' and '%v' or equal to one of them (but it wasn't)!"
	shouldNotHaveBeenBetweenOrEqual  = "Actual value '%v' NOT to be between '%v' and '%v' or equal to one of them (but it was)!"
)
